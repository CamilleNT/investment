...
class TextAreaDemo(EasyFrame):
	...
	def __init__(self):
		...
		self.period = self.addIntegerField(value = 0, row = 2, column = 1)
	...
	def compute(self):
		...
		for year in range(1, years + 1):
			...
			endBalance = startBalance + totalInterestresult += "%4d%18.2f%10.2f%16.2f" % (year, startBalance, interest, endBalance)
